<template>
    <div style="max-height:80vh;">
        ...
        >
            <wj-flex-grid-filter :filterColumns="['userId','rankId','departmentId','employeeUsers','employeeUser','employeeUsers',]" />
            <wj-flex-grid-column binding="index" header="Number" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="employeeUsers[0].name" header="employeeUsers" width="2*" :isReadOnly="true" align="center" />
...
export default {
    ...
    methods:{
        ...
        onSelectionChanged(s) {
            ...
            if (selectedItem) {
                this.selectedGrid = selectedItem.employeeUsers.employeeUser.employeeUsers;
